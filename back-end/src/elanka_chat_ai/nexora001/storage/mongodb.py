...
class MongoDBStorage:
    def __init__(self, uri: Optional[str] = None, database: Optional[str] = None):
        ...
        self.token_usage: Collection = self.db["token_usage"]  # Token usage tracking
    ...
    def get_chatbot_settings(self, client_id: str) -> Optional[Dict]:
        ...
        return {
            ...
            "theme_color": user.get("theme_color", "#EF4444")
        }
...
# --- NOTIFICATIONS SYSTEM ---
    ...
    def log_token_usage(self, client_id: str, session_id: str, prompt_tokens: int, completion_tokens: int, total_tokens: int, model: str = "gemini-2.5-flash"):
        """Log AI token usage for a chat interaction."""
    ...
    def get_token_usage_stats(self, client_id: str, days: int = 30) -> Dict:
        ...
        # Overall totals
        pipeline = [
            {"$match": {"client_id": client_id, "timestamp": {"$gte": start_date}}},
            {"$group": {
                "_id": None,
