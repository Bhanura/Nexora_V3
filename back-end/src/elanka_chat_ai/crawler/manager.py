...
from elanka_chat_ai.crawler.spider import eLankaChatAISpider
from elanka_chat_ai.crawler import settings as crawler_settings
...
class CrawlerManager:
    ...
    def crawl_url(
        ...
        # NOTE: Playwright (scrapy_playwright) requires AsyncioSelectorReactor,
        # but crochet has already installed SelectReactor in this process —
        # they are incompatible. Do NOT inject Playwright DOWNLOAD_HANDLERS here.
        # The spider uses regular Scrapy requests which work fine with crochet.
