...
from elanka_chat_ai.processors.embeddings import EmbeddingGenerator, EmbeddingProvider


class eLankaChatAISpider(scrapy.Spider):
    """
    Spider for crawling websites with JavaScript support via Playwright.
    
    Usage:
        scrapy crawl elanka_chat_ai -a start_url=https://example.com -a max_depth=2
        scrapy crawl elanka_chat_ai -a start_url=https://example.com -a use_playwright=true
    """
    
    name = "elanka_chat_ai"
    
    # User-Agent rotation list for polite crawling
    USER_AGENTS = [
    ...
    def start_requests(self):
        ...
        for url in self.start_urls:
            ...
            # NOTE: Playwright requires AsyncioSelectorReactor which is incompatible
            # with crochet's SelectReactor used in API mode.
            # Regular Scrapy requests work fine and cover most sites.
