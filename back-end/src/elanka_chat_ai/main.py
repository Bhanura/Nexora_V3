"""
eLanka Chat AI002 - Multi-Tenant Console (Admin + Client + User Modes)
This is the interactive console interface for the eLanka Chat AI002 system.
"""
...
from elanka_chat_ai.config import settings, print_config_status
...
from elanka_chat_ai.processors.pdf_processor import PDFProcessor
from elanka_chat_ai.processors.docx_processor import DOCXProcessor
...
def handle_ask(args: str):
    ...
    try:
        ...
        console.print(Panel(Markdown(result['answer']), title="🤖 eLanka Chat AI AI"))
...
def handle_admin_users():
    ...
    with get_storage() as storage:
        ...
        table = Table(title="eLanka Chat AI Clients", header_style="bold red")
