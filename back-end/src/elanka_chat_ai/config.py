"""
Configuration management for eLanka Chat AI. 
...
class Settings(BaseSettings):
    ...
    user_agent: str = Field(default="eLanka Chat AI-Bot/1.0")
...
try:
    ...
    settings = Settings(
        mongodb_uri="",
        mongodb_database="elanka_chat_ai",
        google_api_key="",
        debug=True,
        log_level="INFO",
        ...
        crawl_delay=1.0,
        max_crawl_depth=2,
        user_agent="eLanka Chat AI-Bot/1. 0",
...
def print_config_status():
    ...
    table = Table(title="eLanka Chat AI Configuration Status")
