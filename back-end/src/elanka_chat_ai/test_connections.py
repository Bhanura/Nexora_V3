...
def test_mongodb_connection():
    ...
    try:
        ...
        mongodb_database = os.getenv("MONGODB_DATABASE", "elanka_chat_ai")
...
def test_google_gemini_connection():
    ...
    try:
        ...
        response = model.generate_content("Say 'Hello eLanka Chat AI!' in exactly 3 words.")
...
def test_embedding_generation():
    ...
    try:
        ...
        result = genai.embed_content(
            model=embed_model,
            content="This is a test sentence for eLanka Chat AI.",
...
def main():
    ...
    console.print(Panel(
        "[bold blue]eLanka Chat AI Connection Tests[/bold blue]\n"
